...
TEST(UtilStringTest, normalizeDecimalString_6) {
  std::string original("1.10e10");
  EXPECT_EQ(UtilString::normalizeDecimalString(original), "1.10e10");
  EXPECT_EQ(UtilString::normalizeDecimalStringView(original), "1.10e10");
}
